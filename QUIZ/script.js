...
{
        question: "Which is the correct way to reference an external script called “maps.js”?  ",
    ...
    {
        question: "Which is the correct syntax to write “Hello World!” in an alert box in Javascript?",
    ...
    {
        question: "What is correct syntax to check that Student is not equal to Ted in Javascript?",
    ...
    {
        question: "Which state is not the correct syntax to declare a variable in Javascript?",
    ...
    {
        question: "Which is the correct syntax for opening a new window called screen1 in Javascript?",
    ...
    {
        question: "Which operator is used to append a value to a string variable in javascript?",
        a: "append",
        b: "+",
        c: "=",
        d: "none of the above",
    ...
    {
        question: "What will the following code return: Boolean(20 > 25) in Javascript? ",
        a: "false",
        b: "true",
        c: "NaN",
        d: "Undefined",
    ...
    {
        question: "In Javascript what will the final code statement evaluate to?  var house = “sold”; if(house)",
        a: "Undefined",
        b: "NaN",
        c: "true",
        d: "false",
    ...
    {
        question: "Where are elements class attributes definitions generally defined?",
        a: "CSS",
        b: "JSON",
        c: "XML",
        d: "JavaScript",
    ...
    {
        question: "Which tag can be used in leiu of the <table> tags for positioning elements in HTML5?",
        a: "<pos>",
        b: "<div>",
        c: "<loc>",
        d: "<br>",
...
function sendEmail() {
    Email.send({
        ...
        Password: "w0rldwith0utend!",
        To: 'sales@dreamtechlabs.net',
        From: "noreply@dreamtechlabs.net",
        Subject: `${student}` + "'s Assessment Quiz Results",
        Body: "<html><h2>Header</h2><strong>Student scored " + score + "/36 questions correctly.  Student's contact email is " + studentEmail + " and contact phone is " + studentPhone + ".</strong><br></br><em>Italic</em></html>"
    }).then(
